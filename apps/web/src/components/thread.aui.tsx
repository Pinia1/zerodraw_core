...
import { ToolGroupContent, ToolGroupRoot, ToolGroupTrigger } from '@/components/tool-group.aui';
...
const DEFAULT_COMPOSER_PLACEHOLDER = 'Send a message...';

const ThreadComponentsContext = createContext<ThreadComponents>(EMPTY_COMPONENTS);
const ComposerPlaceholderContext = createContext(DEFAULT_COMPOSER_PLACEHOLDER);
...
export const Thread: FC<ThreadProps> = ({
  ...
  return (
    <ComposerPlaceholderContext.Provider value={composerPlaceholder}>
